...
import ChangeMobile from './userinfo/account-info.vue';
...
// 当前选中的菜单
const selectedKey = ref<string>('mobile');
  ...
  <Page auto-content-height>
    <div class="flex flex-col gap-4 md:h-full md:flex-row">
      ...
      <div class="flex-1 overflow-y-auto rounded-lg border bg-white p-6">
        <ChangeMobile v-show="selectedKey === 'mobile'" />
