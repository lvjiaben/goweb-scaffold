...
(1, 0, 'dashboard', '工作台', '/dashboard', 'dashboard/index', 'menu', '', 'dashboard', 1, TRUE, 1, '{}'::jsonb, NOW(), NOW()),
(2, 0, 'system', '系统管理', '/system', 'layout', 'menu', '', 'setting', 10, TRUE, 1, '{}'::jsonb, NOW(), NOW()),
(3, 2, 'admin-user', '管理员', '/system/admin-user', 'system/admin-user/index', 'menu', '', 'users', 11, TRUE, 1, '{}'::jsonb, NOW(), NOW()),
(4, 2, 'admin-role', '角色管理', '/system/admin-role', 'system/admin-role/index', 'menu', '', 'shield', 12, TRUE, 1, '{}'::jsonb, NOW(), NOW()),
(5, 2, 'admin-menu', '菜单管理', '/system/admin-menu', 'system/admin-menu/index', 'menu', '', 'menu', 13, TRUE, 1, '{}'::jsonb, NOW(), NOW()),
(6, 2, 'system-config', '系统配置', '/system/system-config', 'system/system-config/index', 'menu', '', 'settings', 14, TRUE, 1, '{}'::jsonb, NOW(), NOW()),
(7, 2, 'attachment', '附件管理', '/system/attachment', 'system/attachment/index', 'menu', '', 'paperclip', 15, TRUE, 1, '{}'::jsonb, NOW(), NOW()),
(8, 2, 'codegen', '代码生成', '/system/codegen', 'system/codegen/index', 'menu', '', 'code', 16, TRUE, 1, '{}'::jsonb, NOW(), NOW()),
