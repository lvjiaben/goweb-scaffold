...
(3, 2, 'admin-user', '管理员', '/system/admin-user', 'admin/admin/list', 'menu', '', 'users', 11, TRUE, 1, '{}'::jsonb, NOW(), NOW()),
(4, 2, 'admin-role', '角色管理', '/system/admin-role', 'admin/role/list', 'menu', '', 'shield', 12, TRUE, 1, '{}'::jsonb, NOW(), NOW()),
(5, 2, 'admin-menu', '菜单管理', '/system/admin-menu', 'admin/menu/list', 'menu', '', 'menu', 13, TRUE, 1, '{}'::jsonb, NOW(), NOW()),
(6, 2, 'system-config', '系统配置', '/system/system-config', 'system/config/index', 'menu', '', 'settings', 14, TRUE, 1, '{}'::jsonb, NOW(), NOW()),
(7, 2, 'attachment', '附件管理', '/system/attachment', 'system/attachment/index', 'menu', '', 'paperclip', 15, TRUE, 1, '{}'::jsonb, NOW(), NOW()),
(8, 2, 'codegen', '代码生成', '/system/codegen', 'system/gen/list', 'menu', '', 'code', 16, TRUE, 1, '{}'::jsonb, NOW(), NOW()),
